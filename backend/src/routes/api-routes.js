...
const router=Router()
router.post('/auth/register',registerUser);router.post('/auth/login',loginUser);router.post('/auth/logout',(_,res)=>res.json({success:true,message:'已退出登录'}));router.get('/auth/me',authenticateUser,getCurrentUser)
